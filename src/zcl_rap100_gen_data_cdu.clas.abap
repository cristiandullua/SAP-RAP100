CLASS zcl_rap100_gen_data_cdu DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_cdu IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'cdu',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravcdu.
*    DELETE FROM zrap100_dtravcdu.

    "insert travel demo data
    INSERT zrap100_atravcdu  FROM (
        SELECT
